...
@section('content')
    ...
    <div class="card">
        <div class="card-header header-elements">
            <h2 class="mt-3 me-4 mb-3 text-muted fw-light">Contact</h2>
            <div class="card-title-elements">
                <a href="{{ route('contact.create') }}" class="btn btn-primary"><i class="fa fa-plus me-2"></i>Add New</a>
            </div>
        </div>
