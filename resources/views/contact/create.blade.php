    ...
    <div class="col-md-6">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <x-input name="contact_name" label="Contact Name" value="" wrap="h" />
                <x-input name="email" label="Email" type="email" value="" wrap="h" />
                <x-input name="phone" label="Phone" type="phone" value="" wrap="h" />
                <x-input name="mobile" label="Mobile" type="phone" value="" wrap="h" />
                <x-input name="note" label="Note" value="" wrap="h" />
            </div>
        </div>
